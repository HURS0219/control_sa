...
#define DART_SPRING_B_REVERSE MOTOR_DIRECTION_REVERSE
...
#define DART_M3508_CONFIG(_id, _rev)                                                              \
  {                                                                                               \
    ...
    .controller_param_init_config =                                                               \
        {                                                                                         \
            .speed_PID =                                                                          \
                {.Kp = 2.5f, .Ki = 0.3f, .Kd = 0.0f, .MaxOut = 16384.0f, .DeadBand = 5.0f,        \
                 .IntegralLimit = 1500.0f,                                                        \
                 .Improve = PID_Integral_Limit | PID_Trapezoid_Intergral | PID_ErrorHandle},      \
            .angle_PID =                                                                          \
                {.Kp = 6.0f, .Ki = 0.0f, .Kd = 0.25f, .MaxOut = 3000.0f, .DeadBand = 2.0f,        \
...
#define DART_M2006_CONFIG(_id, _rev)                                                              \
  {                                                                                               \
    ...
    .controller_param_init_config =                                                               \
        {                                                                                         \
            .speed_PID =                                                                          \
                {.Kp = 3.0f, .Ki = 0.5f, .Kd = 0.0f, .MaxOut = 10000.0f, .DeadBand = 8.0f,        \
                 .IntegralLimit = 1500.0f,                                                        \
                 .Improve = PID_Integral_Limit | PID_Trapezoid_Intergral | PID_ErrorHandle},      \
            .angle_PID =                                                                          \
                {.Kp = 6.0f, .Ki = 0.0f, .Kd = 0.25f, .MaxOut = 4000.0f, .DeadBand = 1.0f,        \
                 .Improve = PID_Integral_Limit | PID_Derivative_On_Measurement},                  \
        },                                                                                        \
  }
