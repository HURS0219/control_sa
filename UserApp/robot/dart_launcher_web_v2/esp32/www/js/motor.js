...
const PARAM_FIELDS = [
  [1, "速度前馈 FF", 100, 0.1], [2, "速度 Kp", 100, 0.1], [3, "速度 Ki", 100, 0.1],
  [4, "积分限幅", 100, 1], [5, "角度 Kp", 100, 0.1], [7, "角度 Kd", 100, 0.1],
  [8, "角度缓变", 100, 1], [10, "减速比", 100, 0.01], [11, "角度死区", 100, 0.1],
  [12, "角度限速", 100, 1], [6, "电流限幅", 1, 100]
];
